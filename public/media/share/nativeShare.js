! function (e, t) {
    "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define &&
        define.amd ? define([], t) : "object" == typeof exports ? exports["NativeShare.js"] = t() : e["NativeShare.js"] =
        t()
}(this, function () {
    return function (e) {
        function t(r) {
        ...
        var ae, ce = navigator.userAgent,
            ...
            _e = {
                ...
                encode: function (e) {
                    var t, n, r, o, i, a, c, u = "",
                        l = 0;
                    for (e = _e._utf8_encode(e); l < e.length;) t = e.charCodeAt(l++), n = e.charCodeAt(
                            l++), r = e.charCodeAt(l++), o = t >> 2, i = (3 & t) << 4 | n >> 4, a =
                        (15 & n) << 2 | r >> 6, c = 63 & r, isNaN(n) ? a = c = 64 : isNaN(r) && (c =
                            64), u = u + this._keyStr.charAt(o) + this._keyStr.charAt(i) + this._keyStr
                        .charAt(a) + this._keyStr.charAt(c);
                    return u
                },
                _utf8_encode: function (e) {
                    ...
                    for (var t = "", n = 0; n < e.length; n++) {
                        ...
                        r < 128 ? t += String.fromCharCode(r) : r > 127 && r < 2048 ? (t += String.fromCharCode(
                            r >> 6 | 192), t += String.fromCharCode(63 & r | 128)) : (t +=
            ...
            Se = {
                ...
                icon: function () {
                    return Object(je).href || location.protocol + "//" + location.hostname +
                        "/favicon.ico"
                }(),
                from: "",
                success: r,
                ...
                return ke(e, [{
                    ...
                    value: function () {
                        var e = arguments.length > 0 && void 0 !== arguments[0] ?
                            arguments[0] : {};
                        i(this._shareData, e), this._config.syncDescToTag && l(this._shareData
        ...
        Te.commamdMap = (ae = {}, v(ae, "wechattimeline", 8), v(ae, "wechatfriend", 1), v(ae,
            "qqfriend", 4), v(ae, "qzone", 3), v(ae, "weibo", 11), v(ae, "copyurl", 10), v(ae,
            "more", 5), v(ae, "generateqrcode", 7), v(ae, "default", void 0), ae);
        var Ee, De = Te,
            xe = function () {
                function e(e, t) {
                    for (var n = 0; n < t.length; n++) {
        ...
        Qe.commamdMap = (Ee = {}, O(Ee, "wechattimeline", "kWeixinFriend"), O(Ee, "wechatfriend",
            "kWeixin"), O(Ee, "qqfriend", "kQQ"), O(Ee, "qzone", "kQZone"), O(Ee, "weibo",
            "kSinaWeibo"), O(Ee, "default", void 0), Ee);
        var Me, Ne = Qe,
            Ae = function () {
                function e(e, t) {
                    for (var n = 0; n < t.length; n++) {
            ...
            Ue = function (e) {
                ...
                return T(t, e), Ae(t, [{
                    ...
                    value: function () {
                        ...
                        var n = this.getShareData(),
                            r = this.constructor.commamdMap[String(e).toLowerCase()];
                        ucweb.startRequest("shell.page_share", [n.title, n.desc, n.link,
                            r, "", n.from, n.icon])
                    }
                }]), t
            }(Ce);
        Ue.commamdMap = (Me = {}, P(Me, "wechattimeline", "WechatTimeline"), P(Me, "wechatfriend",
            "WechatFriends"), P(Me, "qqfriend", "QQ"), P(Me, "qzone", "Qzone"), P(Me, "weibo",
            "SinaWeibo"), P(Me, "default", ""), Me);
        var Be = Ue,
            Re = function () {
                function e(e, t) {
                    for (var n = 0; n < t.length; n++) {
            ...
            Fe = function (e) {
                ...
                return N(t, e), ze(t, [{
                    ...
                    value: function (e, t) {
                        ...
                        var n = this.getShareData();
                        location.href =
                            "baidubrowserapp://bd_utils?action=shareWebPage¶ms=" +
            ...
            Ke = function (e) {
                ...
                return I(t, e), Xe(t, [{
                    ...
                    key: "setConfig",
                    value: function (e) {
                        Ge(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype),
                            "setConfig", this).call(this, e), this.init(this.getConfig()
                            .wechatConfig)
                    }
                }, {
                    key: "init",
                        ...
                        e && o("https://res.wx.qq.com/open/js/jweixin-1.2.0.js",
                            function () {
                                ...
                                Object.defineProperty(r, "trigger", {
                                    ...
                                    wx.onMenuShareAppMessage(r), wx.onMenuShareQQ(
                                        r), wx.onMenuShareQZone(r), wx.onMenuShareWeibo(
                                        r), wx.onMenuShareTimeline(r)
                                })
                            })
                    }
                }]), t
                ...
                return L(t, e), Ye(t, [{
                    ...
                    value: function () {
                        ...
                        if (this.setShareData(t), "weibo" !== (e = String(e).toLowerCase()))
                            throw "qqfriend" === e ? h() : "qzone" === e && b(); //new Error(
            ...
            at = function (e) {
                ...
                return K(t, e), ot(t, [{
                    key: "setShareData",
                    value: function (e) {
                        it(t.prototype.__proto__ || Object.getPrototypeOf(t.prototype),
                            "setShareData", this).call(this, e);
                        var n = this.getShareData();
                    ...
                    value: function () {
                        var e = this,
                            t = (arguments.length > 0 && void 0 !== arguments[0] &&
                                arguments[0], arguments[1]);
                        this.setShareData(t);
                        for (var n = this.getShareData(), r = [], o = [], i = [], a = [],
                                c = 0; c < 5; c++) r.push(n.icon), a.push(n.link), o.push(
                            n.title), i.push(n.desc);
            ...
            pt = function (e) {
                ...
                return ne(t, e), st(t, [{
                    ...
                    value: function (e, t) {
                        this.setShareData(t);
                        var n = this.getShareData();
                        window.NativeShareFailCallback = n.fail, window.NativeShareSuccessCallback =
                            n.success, location.href = "baiduboxapp://callShare?" + [
                                ...
                                "successcallback=window.NativeShareSuccessCallback"].join(
                                "&")
                    }
                }]), t
            }(Ce),
            ...
            yt = function (e) {
                ...
                return ie(t, e), bt(t, [{
                    ...
                    value: function (e, t) {
                        ...
                        var n = this.getShareData();
                        window.NativeShareFailCallback = n.fail, window.NativeShareSuccessCallback =
                            n.success, prompt("BdboxApp:" + JSON.stringify({
        ...
        var wt = void 0;
        wt = he ? Ve : be && se ? rt : be && pe ? ct : ye ? ft : de ? De : we && se ? Ne : we && pe ?
            Be : ve && pe ? Ie : ve && se ? Le : ge && se ? He : me && se ? ht : me && pe ? dt : et,
            window.NativeShare = wt, t.default = wt
    }])
});