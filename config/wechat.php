...
return [
    ...
    // 'aes_key' => env('WECHAT_AES_KEY', 'P48TxHYOvwyOgDS9tzkOfnaEXTPs6cdNmgHmXwo11B5'),                    // EncodingAESKey
     ...
     */
     'payment' => [
         'merchant_id'        => base64_decode(env('WECHAT_MERCHANT_ID')),
         'key'                => base64_decode(env('WECHAT_MERCHANT_KEY')),
         'sandbox' => false,
