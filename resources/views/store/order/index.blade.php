...
@endif
@if(count($orders) > 0)
<div class="order-list-box js-order-list-box" data-action="/api/account/store/orders?status_code={{ $form['status_code'] or ''  }}" data-page="1" @if($orders['last_page'] == 1) data-load-more="-1" @endif>
        ...
        <li class="order-item js-order-item js-order-item-{{ $order_item['id'] }} clearfix">
            ...
            <div class="order-item-content clearfix">
                <a href="{{ Helper::route('account_store_order_detail', $order_item['order_no']) }} ">
                    <div class="img lazy">
                        <img src="{{ $order_item['product']['image'] or '' }}" class="lazyload" />
                    </div>
                    <div class="info">
                        <div class="info-box">
            ...
            <div class="operate-box">
                @if($order_item['order_status_code'] == 'shipping')
...
<script type="text/template" id="shipped-template">
    <form name="order-shipped-form" class="order-shipped-form" method="post">
        <div class="shipped-box" style="padding: 10px;max-width: 95%;width: 360px">
            <div style="color: #FF9800;text-align: center;font-size: 18px">订单发货</div>
